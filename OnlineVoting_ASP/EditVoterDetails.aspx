<%@ Page Title="" Language="C#" MasterPageFile="~/Primary.Master" AutoEventWireup="true" CodeBehind="EditVoterDetails.aspx.cs" Inherits="OnlineVoting_ASP.EditVoterDetails" %>
        ...
        <div id="SignUp" runat="server">
            <div class="panel panel-primary">
                <div class="panel-heading panel-heading-custom">
                    <h3 class="panel-title">Edit Voter Details</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtDOB" runat="server" textmode="date" placeholder="Enter your Date Of Birth" Class="form-control"></asp:TextBox>
                    </div>
                    <br />
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtConfirmPassword" runat="server" placeholder="Cinfirm Password" Class="form-control"></asp:TextBox>
                    ...
                    <div class="panel-footer submitt-button-div">
                        <asp:Button ID="btnSignUp" runat="server" class="btn btn-primary" type="submit" Text="Save Data" Font-Italic="True" OnClick="btnSignUp_Click" />
                    </div>
